...
<section class="pt-24 pb-40 lg:px-20 px-10">
    ...
    <div class="lg:grid lg:grid-cols-3 lg:grid-rows-3 gap-8 flex flex-col">
        @foreach ($neurologias as $item)
            
        <a class="bg-white rounded-lg overflow-hidden" href="/servicios/{{$item['ruta']}}">
            <div style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.08);" class="flex w-max-xs">
                    <img src="/imgs/servicios/neurologia/{{$item['img']}}" alt="">
                    <div class="ml-8 lg:ml-6 lg:px-6 lg:py-8 lg:block mr-6 lg:mr-0 justify-center flex-col mx-4 my-auto">
